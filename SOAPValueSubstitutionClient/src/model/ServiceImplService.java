 ...
 * 2013-10-29T18:46:16.273+01:00
 * Generated source version: 2.7.7
 * 
 */
@WebServiceClient(name = "ServiceImplService", 
                  wsdlLocation = "http://localhost:8080/SOAPValueSubstitution/services/ServiceImplPort?wsdl",
...
public class ServiceImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/SOAPValueSubstitution/services/ServiceImplPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/SOAPValueSubstitution/services/ServiceImplPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
