 ...
 * 2013-10-29T19:19:21.857+01:00
 * Generated source version: 2.7.7
 * 
 */
@WebServiceClient(name = "ServiceImplService", 
                  wsdlLocation = "http://localhost:8080/SOAPInterfaceSubstitution/services/ServiceImplPort?wsdl",
                  targetNamespace = "http://model/") 
public class ServiceImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://model/", "ServiceImplService");
    public final static QName ServiceImplPort = new QName("http://model/", "ServiceImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/SOAPInterfaceSubstitution/services/ServiceImplPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/SOAPInterfaceSubstitution/services/ServiceImplPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
    ...
    public ServiceImpl getServiceImplPort() {
        return super.getPort(ServiceImplPort, ServiceImpl.class);
    }
    ...
    public ServiceImpl getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(ServiceImplPort, ServiceImpl.class, features);
    }
