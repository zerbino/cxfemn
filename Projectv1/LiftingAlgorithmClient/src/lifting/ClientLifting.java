 ...
 * The class is only used for the lifting algorithm itself. The conditions to call it must
 * be coded elsewhere.
 * 
 * The treeInclusion method corresponds to what must be done depending on where the entity
 * is being sent (to the client or to the server). 
 * 
 * @author raphael
 *
 */
